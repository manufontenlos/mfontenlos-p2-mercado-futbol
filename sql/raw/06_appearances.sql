-- =====================================================================
-- RAW · 06_appearances.sql
-- Tabla: appearances.csv
--
...
CREATE OR REPLACE TABLE FOOTBALL.RAW.APPEARANCES
  USING TEMPLATE (
    SELECT ARRAY_AGG(
             OBJECT_CONSTRUCT(
...
ALTER TABLE FOOTBALL.RAW.APPEARANCES
...
CREATE OR REPLACE PIPE FOOTBALL.RAW.PIPE_APPEARANCES
  AUTO_INGEST = TRUE
