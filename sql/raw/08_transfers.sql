...
CREATE OR REPLACE TABLE FOOTBALL.RAW.TRANSFERS
  USING TEMPLATE (
    SELECT ARRAY_AGG(
             OBJECT_CONSTRUCT(
...
ALTER TABLE FOOTBALL.RAW.TRANSFERS
...
CREATE OR REPLACE PIPE FOOTBALL.RAW.PIPE_TRANSFERS
  AUTO_INGEST = TRUE
